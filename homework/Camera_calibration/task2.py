...
images = glob.glob(os.path.join('homework', 'Camera_calibration', 'Calibration_images', 'AR*.jpg'))
...
#save parameters
np.savez('camera_calibration_params.npz', intrinsic_matrix=mtx, distortion_coefficients=dist)
